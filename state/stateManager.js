...
// Note: In serverless environments (Vercel), this interval runs per warm instance
// and resets on cold starts. Stale sessions are also pruned on-demand via getOrCreate.
