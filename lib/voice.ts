...
// Browser Speech Recognition type declarations (cross-browser)
...
class VoiceEngine {
  ...
  constructor() {
    if (typeof window !== 'undefined') {
      const SpeechRecognitionAPI = (window as Window & { SpeechRecognition?: new () => ISpeechRecognition; webkitSpeechRecognition?: new () => ISpeechRecognition }).SpeechRecognition
